    ...
    <div className="w-full max-w-sm flex flex-col items-center text-center gap-6">
      {status === "loading" && (
        <div className="flex flex-col items-center gap-3">
          ...
          <h2 className="text-xl font-bold text-text dark:text-[hsl(174_20%_94%)]" style={{ fontFamily: "Syne, sans-serif" }}>
            Verificando cuenta
          </h2>
      ...
      {status === "success" && (
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-muted mt-2">Redirigiéndote al inicio de sesión…</p>
        </div>
      )}
