...
import { getProxyImageUrl } from "@/lib/utils"; // Importa la función
      ...
      {esMiPerfil && (
        <>
          <button
            ...
            className="absolute bottom-0 right-0 bg-[hsl(174_72%_40%)] hover:bg-[hsl(174_72%_35%)] text-white p-2.5 rounded-full shadow-lg border-2 border-white dark:border-slate-900 transition-transform active:scale-95 cursor-pointer z-10"
